                    ...
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                      {products.map((product, index) => (
                        <Link to="/product-detail" >
                          <div key={index} className="group relative product-card border-solid border-2 p-2">
                            <div className="min-h-60 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-95 duration-200 group-hover:scale-105 lg:h-60">
                              <img
                                src={
                                  product.thumbnail
                                }
                            ...
                            <div className="mt-4 flex justify-between">
                              <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                  <StarIcon className='h-4 w-4 inline-block text-yellow-500' />
